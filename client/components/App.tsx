...
function App() {
  ...
  useEffect(() => {
    // const ws = new WebSocket('wss://etnz-dashboard.borb.nz/') --> for the deployed version
    const ws = new WebSocket('ws://localhost:3000/') // for the local websocket running on local host 3000
